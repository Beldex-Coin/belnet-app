...
import '../model/exitnodeCategoryModel.dart';
...
List<ExitNodeDataList> ranExitData=[];
List ids = [];
var selectedId;
var exitName="", exitIcon="";

getRandomExitnode()async{
  var responses = await getListData();
 ...
 exitData.forEach((element) {
  element.node.forEach((element) {
    if(selectedId == element.id){
       exitName = element.name;
       exitIcon = element.icon;
    }
  });
 });
  setState(() {
                ...
                child: Container(
                    ...
                    child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              child: SvgPicture.network(exitIcon),
