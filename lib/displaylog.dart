      ...
      child: Column(
        ...
        children: [
          Flexible(
              child: Padding(
            padding:
                EdgeInsets.only(left:MediaQuery.of(context).size.height * 0.08 / 3,
                right:MediaQuery.of(context).size.height * 0.08 / 3,top:MediaQuery.of(context).size.height * 0.06 / 3,
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                border: Border.all(color:Colors.grey.withOpacity(0.1)),
                  ...
                  color:appModel.darkTheme ? Color(0xff252532):Colors.white ),
                          ...
                          child:Row(
                            ...
                            children: [
                               Padding(
                                 ...
                                 child: SvgPicture.asset('assets/images/clear_x.svg'),
                                 //child: Icon(Icons.close,size:MediaQuery.of(context).size.height*0.07/3 ,color: Color(0xffFF3030),),
                               ),
                               Text("cancel",style: TextStyle(fontWeight: FontWeight.w900,fontSize: MediaQuery.of(context).size.height*0.05/3,fontFamily:"Poppins",color:Color(0xffFF3030)),)
                          ],
                          )
                        ),
                    ...
                    InkWell(
                      onTap: (){
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          ...
                          content: Text("Copied successfully!",style: TextStyle(color:Colors.white),)
                  ...
                  blurRadius: 2.0)
                          ...
                          child: Row(
                            ...
                            children: [
                               ...
                               Text("copy",style: TextStyle(fontWeight: FontWeight.w900,fontSize: MediaQuery.of(context).size.height*0.05/3,fontFamily:"Poppins",color:Color(0xff1DC021)),)
                          ],
                          ),
                        ),
                      ),
