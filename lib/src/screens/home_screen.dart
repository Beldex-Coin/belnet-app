...
final _formKey = GlobalKey<FormState>();
  final _exitNodeController = TextEditingController();
    ...
    return Padding(
      ...
      //                               )
         ...
         // NetworkStatusCard()
              ...
              //       position: _offsetAnimation,
              //       child: GestureDetector(
              //         onTap:loaderVideoProvider.conStatus != ConnectionStatus.CONNECTED ? widget.onNavigateToExitNodes : null,
              //         child: Container(
              //             height: MediaQuery.of(context).size.height*0.35/3,width: double.infinity,
              //             margin: EdgeInsets.symmetric(horizontal: 10,vertical: 5),
              //             decoration: BoxDecoration(
              //               borderRadius: BorderRadius.circular(10),
              //               color: Color(0xFF00B400).withOpacity(0.02),
              //               border: Border.all(color: appModel.darkTheme ? Color(0xff00DC00) :Color(0xFF00B400),
              //               width:appModel.darkTheme ? 0.8 : 0.3),
              //               boxShadow:appModel.darkTheme ? [] :[
              //                      BoxShadow(
              //       color: Color(0xFF00B400).withOpacity(0.1) ,// Colors.black12,,
              ...
              //                   decoration: BoxDecoration(
              //                     shape: BoxShape.circle,
              //                    color: appModel.darkTheme ? Colors.white.withOpacity(0.1) : Color(0xffBEBEBE).withOpacity(0.3)
              //                   ),
              //                   padding: EdgeInsets.all(10),
              ...
              //                     mainAxisAlignment: MainAxisAlignment.center,
              //                     children: [
              //                       Text('${nodeProvider.selectedExitNodeCountry}', style: TextStyle(fontFamily: 'Poppins',fontSize: 12,color:appModel.darkTheme ? Color(0xffACACAC) : Colors.black)),
              //                       SizedBox(height: 5,),
              ...
              //                 ),
              //                 SizedBox(width: 10,),
              //                loaderVideoProvider.conStatus != ConnectionStatus.CONNECTED ? Container(
              //                   height: 35,width: 35,
              //                   decoration: BoxDecoration(
              //                     shape: BoxShape.circle,
              //                     color:appModel.darkTheme ? Colors.white.withOpacity(0.1) : Color(0xffBEBEBE).withOpacity(0.3)
              ...
              //         backgroundColor:appModel.darkTheme ? Colors.white.withOpacity(0.1) : Color(0xffBEBEBE).withOpacity(0.3),
              //         radius: 20,
              //         child: SvgPicture.asset('assets/images/dark_theme/connection.svg',color: appModel.darkTheme ? Colors.white : Colors.black,) //Icon(Icons.download, color: Colors.white, size: 20),
              //       ),
              //     ),
              //     // CircleAvatar(
              //     //   backgroundColor: Colors.white.withOpacity(0.1),
              ...
              //     // ),
              //     SizedBox(height: 8),
              //     Text("Status", style: TextStyle(color:appModel.darkTheme ? Colors.white70 : Color(0xff4D4D4D), fontSize: 12)),
              //     SizedBox(height: 4),
              //     Text(capitalizeFirstLetter(loaderVideoProvider.conStatus.name), style: TextStyle(color:loaderVideoProvider.conStatus == ConnectionStatus.CONNECTED ?  Color(0xff00DC00) : loaderVideoProvider.conStatus == ConnectionStatus.CONNECTING ? Colors.blue : appModel.darkTheme ? Colors.white : Colors.black, fontSize: 14, fontWeight: FontWeight.bold)),
              //               ],
              //             ),
              //           ),
              //         ),
              ...
              //     ),
              //     SizedBox(height: 8),
              //     Text("Download", style: TextStyle(color: appModel.darkTheme ? Colors.white70 : Color(0xff4D4D4D), fontSize: 12)),
              //     SizedBox(height: 4),
              //     Text(loaderVideoProvider.conStatus == ConnectionStatus.CONNECTED ? '${stringBeforeSpace(appModel.singleDownload)} ${stringAfterSpace(appModel.singleDownload)}' : '0.0 Mb/s', //displaySpeed(speedChartProvider.download), //"40.5 Mb/s",
              //      style: TextStyle(color:appModel.darkTheme ? Colors.white : Colors.black, fontSize: 14,// fontWeight: FontWeight.bold
              //      )),
              //               ],
              //             ),
              //           ),
              ...
              //         backgroundColor:appModel.darkTheme ? Colors.white.withOpacity(0.1) : Color(0xffBEBEBE).withOpacity(0.3),
              //         radius: 20,
              //         child: SvgPicture.asset('assets/images/dark_theme/upload.svg') //Icon(Icons.download, color: Colors.white, size: 20),
              //       ),
              //     ),
              //     // CircleAvatar(
              //     //   backgroundColor: Colors.white.withOpacity(0.1),
              ...
              //     // ),
              //     SizedBox(height: 8),
              //     Text("Upload", style: TextStyle(color: appModel.darkTheme ? Colors.white70 : Color(0xff4D4D4D), fontSize: 12)),
              //     SizedBox(height: 4),
              //     Text(loaderVideoProvider.conStatus == ConnectionStatus.CONNECTED ? '${stringBeforeSpace(appModel.singleUpload)} ${stringAfterSpace(appModel.singleUpload)}': '0.0 Mb/s', //displaySpeed(speedChartProvider.upload), //"12.5 Mb/s", 
              //     style: TextStyle(color:appModel.darkTheme ? Colors.white : Colors.black, fontSize: 14, //fontWeight: FontWeight.bold
              //     )),
...
void showCustomDialog(BuildContext context,AppModel appModel) {
  ...
  //     return CustomAddExitNodeDialog();
  //   },
  // );
}
...
// String? validateExitNode(String? value) {
//     if (value == null || value.length < 20) {
//       return 'Please Enter Valid Exit Node';
//     }
//     return null;
//   }
...
//     if (value == null || value.length < 20) {
//       return 'Please Enter Valid Auth Code';
//     }
//     return null;
//   }
...
// Widget containerWidget(BuildContext dcontext,double mHeight,AppModel appModel) {
...
//        // decoration: BoxDecoration(
//           color: appModel.darkTheme ?const Color(0xff1C1C26) :const Color(0xffF5F5F5).withOpacity(0.6),
...
//               //       border: Border.all(color: textForExit == null ?  Colors.transparent :
//               //        Color(0xffF41A06) 
//               //        )
//               //       ),
//               //   child: TextFormField(
...
//                 decoration: BoxDecoration(
//                     color: appModel.darkTheme ? const Color(0xff292937) : Color(0xffBEBEBE).withOpacity(0.11),
//                     borderRadius: BorderRadius.circular(5.0),
//                       border: Border.all(color: textForAuth == null ?  Colors.transparent :
//                      Color(0xffF41A06) )
//                     ),
//                 child: 
//                 // isAuthCode
...
//                           border: Border.all(color:isSet ? Color(0xff00B400) : Color(0xffACACAC),width: 0.3),
//                           //color: Colors.grey,
//                           // gradient: LinearGradient(
